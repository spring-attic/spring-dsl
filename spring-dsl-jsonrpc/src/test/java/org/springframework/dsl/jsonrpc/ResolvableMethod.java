...
public class ResolvableMethod {
	...
	private static final Logger log = LoggerFactory.getLogger(ResolvableMethod.class);
		...
		if (type.isInterface()) {
			...
			if (objenesis.isWorthTrying()) {
				try {
					...
					log.debug("Objenesis failed, falling back to default constructor", ex);
				}
			}
